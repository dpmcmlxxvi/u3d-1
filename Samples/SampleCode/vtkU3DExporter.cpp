...
//  vtkActor2D *anTextActor2D, *aPart2D;
    ...
    // 1 ACTOR
    std::ofstream outfile1 ("test_u3d_1.txt");
    outfile1 << "BEFORE 1 ACTOR" << std::endl;
    outfile1.close();
    ...
    // BEFORE SUCCESS
    std::ofstream outfile2 ("test_u3d_2.txt");
    outfile2 << "BEFORE SUCCESS" << std::endl;
    outfile2.close();
    ...
    if (!IFXSUCCESS(result)) {
        vtkErrorMacro("locale error.");
        return;
    }

    std::ofstream outfile3 ("test_u3d_3.txt");
    outfile3 << "after_locale_error" << std::endl;
    outfile3.close();
...

    {
        ...
        std::wofstream outfile4 ("test_u3d_4.txt");
        outfile4 << wU3DFileName << std::endl;
        outfile4.close();
        ...
        std::ofstream outfile5 ("test_u3d_5.txt");
        outfile5 << "after_scene_converter_init" << std::endl;
        outfile5.close();

        // New Check...
        if (!IFXSUCCESS(result)) {
            vtkErrorMacro("result error.");
            return;
        }
        ...
        if (IFXSUCCESS(result)) {
            ...
            {
                std::ofstream outfile6 ("test_u3d_6.txt");
                outfile6 << "after_success_check_2" << std::endl;
                outfile6.close();
                ...
                std::ofstream outfile7 ("test_u3d_7.txt");
                outfile7 << "after_camera_init" << std::endl;
                outfile7.close();
